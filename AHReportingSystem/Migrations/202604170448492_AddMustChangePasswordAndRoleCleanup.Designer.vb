...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddMustChangePasswordAndRoleCleanup
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddMustChangePasswordAndRoleCleanup))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202604170448492_AddMustChangePasswordAndRoleCleanup"
            End Get
        End Property
