...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddUserCompanyTable
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddUserCompanyTable))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202604231519203_AddUserCompanyTable"
            End Get
        End Property
