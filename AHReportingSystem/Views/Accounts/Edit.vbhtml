...
@Code
    ViewBag.Title = Strings.Accounts_Edit
    ...
    <div class="col-md-8">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-2"></i> @Strings.Accounts_Edit</h3>
            </div>
            <form action="@Url.Action("Edit")" method="post" novalidate="novalidate">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @Html.TextBoxFor(Function(m) m.IdCuenta, New With {.class = "form-control text-uppercase", .readonly = "readonly"})
                    </div>
...
@Section scripts
    <script>
        (function () {
            ...
            function populateSubs(catId, preserve) {
                var $sc = $('#SubCategoryId');
                var prev = preserve ? $sc.data('selected') : null;
            ...
            $(function () {
                ...
                $('#CategoryId').on('change', function () { populateSubs($(this).val(), false); });
                var initial = $('#CategoryId').val();
                if (initial) populateSubs(initial, true);
            });
        })();
    </script>
End Section
