@ModelType AHReportingSystem.Models.ViewModels.CategoryFormViewModel
@Imports AHReportingSystem.Resources

@Code
    ViewBag.Title = Strings.Categories_Create
    ViewBag.BreadcrumbParent = Strings.Categories_Title
End Code
    ...
    <div class="col-md-6">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus mr-2"></i> @Strings.Categories_Create</h3>
            </div>
            <form action="@Url.Action("Create")" method="post" novalidate="novalidate">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @Html.TextBoxFor(Function(m) m.Name, New With {.class = "form-control", .autofocus = "autofocus"})
