...
@Code
    ViewBag.Title = Strings.Companies_Create
    ...
    <div class="col-md-6">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus mr-2"></i> @Strings.Companies_Create</h3>
            </div>
            <form action="@Url.Action("Create")" method="post" novalidate="novalidate">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @Html.TextBoxFor(Function(m) m.Code, New With {.class = "form-control text-uppercase", .maxlength = "20", .autofocus = "autofocus"})
