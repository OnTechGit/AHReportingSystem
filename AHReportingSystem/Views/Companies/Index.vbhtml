@ModelType IEnumerable(Of AHReportingSystem.Models.ViewModels.CompanyListItemViewModel)
@Imports AHReportingSystem.Resources

@Code
    ViewBag.Title = Strings.Companies_Title
End Code

<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-building mr-2"></i> @Strings.Companies_Title</h3>
        <div class="card-tools">
            <a href="@Url.Action("Create")" class="btn btn-primary btn-sm">
                <i class="fas fa-plus mr-1"></i> @Strings.Companies_New
            </a>
        </div>
    </div>
    <div class="card-body">
        <table id="tbl" class="table table-hover table-striped" style="width:100%">
            <thead>
                <tr>
                    <th>@Strings.Companies_Col_Code</th>
                    <th>@Strings.Companies_Col_Name</th>
            ...
            <tbody>
                @For Each c In Model
                    ...
                    @<tr>
                        ...
                        <td class="text-right">
                            <a href="@Url.Action("Edit", New With {.id = c.CompanyId})" class="btn btn-sm btn-outline-primary" title="@Strings.Common_Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="@Url.Action("ToggleActive", New With {.id = c.CompanyId})" method="post" class="d-inline">
