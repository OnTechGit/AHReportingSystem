@If Request.IsAuthenticated Then
    Using Html.BeginForm("LogOut", "Account", FormMethod.Post, New With {.id = "logoutForm", .class = "navbar-right"})
        @Html.AntiForgeryToken()
        @<ul class="nav navbar-nav navbar-right">
            <li>
                <a href="@Url.Action("Index", "Manage")">Hello, @User.Identity.Name!</a>
            </li>
            <li>
