...
@Code
    ViewBag.Title = Strings.SubCategories_Edit
    ...
    <div class="col-md-6">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-edit mr-2"></i> @Strings.SubCategories_Edit</h3>
            </div>
            <form action="@Url.Action("Edit")" method="post" novalidate="novalidate">
                @Html.AntiForgeryToken()
                @Html.HiddenFor(Function(m) m.SubCategoryId)
                <div class="card-body">
